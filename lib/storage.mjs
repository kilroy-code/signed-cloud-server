...
import {dbPath} from './tagPath.mjs';
import {enqueueRequest} from './queue.mjs';
import {deepVerify} from './verify.mjs';
...
keys.put('/:collectionName/:tag.json', enqueueRequest, deepVerify, storeVerifiedBody, answerEmptyJSON);

export default keys;
export {keys, dbPath, enqueueRequest, deepVerify, storeVerifiedBody, answerEmptyJSON}; 
